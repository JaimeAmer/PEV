...
public class GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Funcion 1", "Funcion 2", "Funcion 3", "Funcion 4", "Funcion 4-R", "Funcion 5" }));

        jLabel9.setText("Metodo de Seleccion");

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ruleta", "Ranking", "Torneo", "Torneo Probabilistico", "Estocastico Universal" }));

        jLabel11.setText("Tipo de Algoritmo (Solo en Funcion 4-R)");

        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Externo", "Discreto Uniforme", "Aritmetico", "SBX" }));
